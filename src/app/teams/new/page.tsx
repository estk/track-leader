...
import { api, TeamVisibility, TeamJoinPolicy } from "@/lib/api";
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <RadioCard
                  ...
                  description="Users can only join through an invitation from an admin"
                />
                <RadioCard
                  ...
                  description={
                    visibility === "private"
                      ...
                      : "Users can request to join, admins approve"
                  }
                />
                <RadioCard
