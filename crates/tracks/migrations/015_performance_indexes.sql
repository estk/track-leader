...
CREATE INDEX IF NOT EXISTS idx_activities_feed
...
CREATE INDEX IF NOT EXISTS idx_kudos_activity
...
-- TODO: Add index for starred_segments when that table is created
