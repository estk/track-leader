...
pub use activities::{
    ...
    __path_get_user_activities, __path_new_activity, __path_preview_activity,
    __path_reprocess_dig_parts, __path_update_activity, ActivitiesByDateQuery,
    PreviewActivityResponse, PreviewSportSegment, PreviewTrackPoint, ReprocessDigPartsResult,
    TrackBounds, TrackData, TrackPoint, UpdateActivityRequest, UploadQuery, UserActivitiesQuery,
    create_dig_parts, delete_activity, delete_dig_part, download_gpx_file, get_activities_by_date,
    get_activity, get_activity_segments, get_activity_sensor_data, get_activity_track,
    get_dig_parts, get_dig_time, get_stopped_segments, get_user_activities, new_activity,
    preview_activity, reprocess_dig_parts, update_activity,
};
...
pub use teams::{
    ...
    __path_discover_teams, __path_get_activity_teams, __path_get_global_dig_heatmap,
    __path_get_invitation, __path_get_join_requests, __path_get_segment_teams, __path_get_team,
    __path_get_team_activities, __path_get_team_activities_by_date, __path_get_team_dig_heatmap,
    __path_get_team_invitations, __path_get_team_leaderboard, __path_get_team_segments,
    __path_invite_to_team, __path_join_team, __path_leave_team, __path_list_my_teams,
    __path_list_team_members, __path_remove_team_member, __path_review_join_request,
    __path_revoke_invitation, __path_share_activity_with_teams, __path_share_segment_with_teams,
    __path_unshare_activity_from_team, __path_unshare_segment_from_team, __path_update_team,
    DigHeatmapQuery, DiscoverTeamsQuery, ReviewJoinRequestRequest, TeamActivitiesByDateQuery,
    TeamContentQuery, TeamLeaderboardQuery, TeamLeaderboardResponse, accept_invitation,
    change_member_role, create_team, delete_team, discover_teams, get_activity_teams,
    get_global_dig_heatmap, get_invitation, get_join_requests, get_segment_teams, get_team,
    get_team_activities, get_team_activities_by_date, get_team_dig_heatmap, get_team_invitations,
